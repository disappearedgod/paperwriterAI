"""
研究编号: RS-20260621-032
论文标题: AI Economist Agent: An Agentic Framework for Model-Grounded Economic Analysis wi
研究主题: AI Economist Agent: An Agentic Framework for Model-Grounded Economic Analysis with RAG, Knowledge Graphs, and Large Language Models（扩展 060923）

数据位置:
  - MongoDB: mongodb://localhost:27017 / quant_db / daily_bars
  - 种子文献: /Users/derek/Documents/Github/paperwriterAI/data/seed_papers
  - 本研究档案: /Users/derek/Documents/Github/paperwriterAI/data/research/RS-20260621-032_AI_Economist_Agent_An_Agentic_Framework_
"""

MONGO_URI = 'mongodb://localhost:27017'
MONGO_DB = 'quant_db'
MONGO_COLLECTION = 'daily_bars'
RESEARCH_ID = 'RS-20260621-032'
