"""
研究编号: RS-20260621-045
论文标题: Martingale Doppelgänger-Eval: An Identification Framework for Auditing Candlesti
研究主题: Martingale Doppelgänger-Eval: An Identification Framework for Auditing Candlestick Understanding in Vision-Language Models（扩展 071005）

数据位置:
  - MongoDB: mongodb://localhost:27017 / quant_db / daily_bars
  - 种子文献: /Users/derek/Documents/Github/paperwriterAI/data/seed_papers
  - 本研究档案: /Users/derek/Documents/Github/paperwriterAI/data/research/RS-20260621-045_Martingale_Doppelg_nger_Eval_An_Identifi
"""

MONGO_URI = 'mongodb://localhost:27017'
MONGO_DB = 'quant_db'
MONGO_COLLECTION = 'daily_bars'
RESEARCH_ID = 'RS-20260621-045'
