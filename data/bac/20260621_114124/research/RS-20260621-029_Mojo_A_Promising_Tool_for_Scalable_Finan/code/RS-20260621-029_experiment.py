"""
研究编号: RS-20260621-029
论文标题: Mojo: A Promising Tool for Scalable Financial AI Efficiency（扩展 062228）
研究主题: Mojo: A Promising Tool for Scalable Financial AI Efficiency（扩展 062228）

数据位置:
  - MongoDB: mongodb://localhost:27017 / quant_db / daily_bars
  - 种子文献: /Users/derek/Documents/Github/paperwriterAI/data/seed_papers
  - 本研究档案: /Users/derek/Documents/Github/paperwriterAI/data/research/RS-20260621-029_Mojo_A_Promising_Tool_for_Scalable_Finan
"""

MONGO_URI = 'mongodb://localhost:27017'
MONGO_DB = 'quant_db'
MONGO_COLLECTION = 'daily_bars'
RESEARCH_ID = 'RS-20260621-029'
